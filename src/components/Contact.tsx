...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-16 md:py-24 bg-[#1a1a1a] text-white">
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <div>
            {/* Map Embed */}
            <div className="relative aspect-video rounded-lg overflow-hidden retro-border mb-8">
              <iframe
            ...
            <div className="bg-white/5 rounded-lg p-6">
              ...
              <a
                ...
                className="btn bg-[#C41E3A] hover:bg-[#a01830] text-white border-none font-headline tracking-wider mt-4"
              >
